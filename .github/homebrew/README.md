...
```bash
# Download binaries
curl -LO https://github.com/redentordev/tako-cli/releases/download/v0.2.2/tako-darwin-arm64
curl -LO https://github.com/redentordev/tako-cli/releases/download/v0.2.2/tako-darwin-amd64
curl -LO https://github.com/redentordev/tako-cli/releases/download/v0.2.2/tako-linux-arm64
curl -LO https://github.com/redentordev/tako-cli/releases/download/v0.2.2/tako-linux-amd64
